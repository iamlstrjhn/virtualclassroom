		...
		<section class="cover-register">
			...
			<div class="container">
	          <div class="card card-for-login animated fadeInUp">
	                <form action="<?php echo base_url('Studentlogin/login_acct'); ?>" method="post">
	                      <h6 class="h5-login">LOGIN ACCOUNT FOR STUDENT</h6>
	                 ...
	                 <h6 class="h5-login-account">Need an account? <a href="<?php echo base_url('Studentlogin/register'); ?>" style="font-weight: 600; color: #2196f3;">REGISTER HERE</a></h6>
	          </div>
	        </div>
		</section>
	</center>
